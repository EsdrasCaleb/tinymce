...
var inlite = (function () {
  ...
  var $_5bb57n174ji394ngm = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_2md59178ji394ngp.fromClientRect(clientRect)) : null;
  };
  var $_hkluu177ji394ngo = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_7v65qt176ji394ngn.result(predicateIds[i].id, $_hkluu177ji394ngo.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_7v65qt176ji394ngn.result(predicateIds[x].id, $_hkluu177ji394ngo.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_7v65qt176ji394ngn.result(id, $_hkluu177ji394ngo.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_7v65qt176ji394ngn.result(id, $_hkluu177ji394ngo.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_3lwhqc17hji394nh8.isArray(value)) {
      return value;
    } else if ($_3lwhqc17hji394nh8.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_3lwhqc17hji394nh8.isBoolean(value)) {
  ...
  var $_e0wcsm17gji394nh7 = {
    getStringOr: getByTypeOr($_3lwhqc17hji394nh8.isString),
    getBoolOr: getByTypeOr($_3lwhqc17hji394nh8.isBoolean),
    getNumberOr: getByTypeOr($_3lwhqc17hji394nh8.isNumber),
    getHandlerOr: getByTypeOr($_3lwhqc17hji394nh8.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_3lwhqc17hji394nh8.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_2md59178ji394ngp.toClientRect(targetRect),
        contentAreaRect: $_2md59178ji394ngp.toClientRect(contentAreaRect),
        panelRect: $_2md59178ji394ngp.toClientRect(panelRect)
      });
      return $_2md59178ji394ngp.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_e0wcsm17gji394nh7.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_e0wcsm17gji394nh7.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_e0wcsm17gji394nh7.getHandlerOr(editor, 'inline_toolbar_position_handler', $_88d5u317iji394nh9.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_b3iass17dji394nh5.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_4825f417eji394nh6.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_4825f417eji394nh6.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_a98jxi17cji394ngs = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_5bb57n174ji394ngm.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_9tku0j179ji394ngq.fromContextToolbars(toolbars);
    result = $_7v65qt176ji394ngn.match(editor, [
      $_cmgugy175ji394ngm.element(elements[0], contextToolbarsPredicateIds),
      $_5jb0p417bji394ngr.textSelection('text'),
      $_5jb0p417bji394ngr.emptyTextBlock(elements, 'insert'),
      $_cmgugy175ji394ngm.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_7v65qt176ji394ngn.match(editor, [$_5jb0p417bji394ngr.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_a98jxi17cji394ngs.load(editor, function () {
  ...
  var $_2ehxdb170ji394ngi = { renderUI: renderUI };
  ...
  var never$1 = $_7dseed17nji394nhq.never;
  var always$1 = $_7dseed17nji394nhq.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_7dseed17nji394nhq.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_3vr27g17oji394nht.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_bvyg2j17lji394nhh = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_5s5m5217vji394nie.parseBox(settings.border);
      self.paddingBox = $_5s5m5217vji394nie.parseBox(settings.padding);
      self.marginBox = $_5s5m5217vji394nie.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_adbg7n183ji394nj3.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_5s5m5217vji394nie.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_5s5m5217vji394nie.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_5s5m5217vji394nie.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_5at7nc182ji394nj2.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_adbg7n183ji394nj3.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_adbg7n183ji394nj3.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_7vhd19184ji394nj5 = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_adbg7n183ji394nj3.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_adbg7n183ji394nj3.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_bvyg2j17lji394nhh.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_bvyg2j17lji394nhh.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_5s5m5217vji394nie.parseBox(self.settings.border);
          ...
          self.borderBox = $_5s5m5217vji394nie.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_2ehxdb170ji394ngi.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_dyjnlz16zji394ngg = { get: get };
  ...
  var unsafe = function (name, scope) {
    return $_b0vgks18nji394nkv.resolve(name, scope);
  };
  ...
  var $_eedmm818mji394nks = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_eedmm818mji394nks.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_20zbi418kji394nko = { blobToBase64: blobToBase64 };
  ...
  var $_bdqhgy18qji394nkx = { pickFile: pickFile };
  ...
  var $_394wrp18sji394nl2 = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_s096a18uji394nl4.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_s096a18uji394nl4.resolve(dom, bookmark));
  };
  ...
  var $_eofsd18tji394nl3 = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_394wrp18sji394nl2.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_eofsd18tji394nl3.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_8n719g18rji394nl0.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_bdqhgy18qji394nkx.pickFile().then(function (files) {
          var blob = files[0];
          $_20zbi418kji394nko.blobToBase64(blob).then(function (base64) {
            $_8n719g18rji394nl0.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_8n719g18rji394nl0.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_6grdfb18jji394nkn = { addToEditor: addToEditor };
  ...
  var $_cuxoxt18yji394nl9 = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_9lh9id190ji394nld.isAbsolute(href) && $_9lh9id190ji394nld.isDomainLike(href) ? askAboutPrefix(editor, href) : global$13.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_8n719g18rji394nl0.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_8n719g18rji394nl0.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_372c2s18zji394nlb = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_3lwhqc17hji394nh8.isArray(items)) {
      return items;
    } else if ($_3lwhqc17hji394nh8.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_3lwhqc17hji394nh8.isFunction(button)) {
            button = button();
          }
  ...
  var $_444bx1191ji394nld = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_444bx1191ji394nld.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_444bx1191ji394nld.create(editor, 'text', $_4825f417eji394nh6.getTextSelectionToolbarItems(editor)),
        $_444bx1191ji394nld.create(editor, 'insert', $_4825f417eji394nh6.getInsertToolbarItems(editor)),
        $_372c2s18zji394nlb.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_4825f417eji394nh6.getPositionHandler(editor);
      contentAreaRect = $_hkluu177ji394ngo.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_88d5u317iji394nh9.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_88d5u317iji394nh9.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_cuxoxt18yji394nl9.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_88d5u317iji394nh9.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_hkluu177ji394ngo.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_88d5u317iji394nh9.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_88d5u317iji394nh9.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_b3iass17dji394nh5.fireBeforeRenderUI(editor);
  ...
  var $_633qkx19oji394nne = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_7dseed17nji394nhq.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_4902i019pji394nng = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_2eseip19tji394nnp = { cached: cached };

  var $_5z90pg19vji394nnr = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_5z90pg19vji394nnr.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_5z90pg19vji394nnr.ELEMENT);
  var isText = isType$2($_5z90pg19vji394nnr.TEXT);
  var isDocument = isType$2($_5z90pg19vji394nnr.DOCUMENT);
  var $_2jf0v919uji394nnq = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_2jf0v919uji394nnq.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_2eseip19tji394nnp.cached(function () {
    return getBody($_4902i019pji394nng.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_4902i019pji394nng.fromDom(body);
  };
  var $_bdrebr19sji394nnn = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_bvyg2j17lji394nhh.each(fields, function (name, i) {
        struct[name] = $_7dseed17nji394nhq.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_3vr27g17oji394nht.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_bvyg2j17lji394nhh.each(array, function (a) {
      if (!$_3vr27g17oji394nht.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_bvyg2j17lji394nhh.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_6msrcs1a1ji394no2.validateStrArr('required', required);
    $_6msrcs1a1ji394no2.validateStrArr('optional', optional);
    $_6msrcs1a1ji394no2.checkDupes(everything);
    return function (obj) {
      var keys = $_2zmtza1a0ji394no1.keys(obj);
      var allReqd = $_bvyg2j17lji394nhh.forall(required, function (req) {
        return $_bvyg2j17lji394nhh.contains(keys, req);
      });
      if (!allReqd)
        $_6msrcs1a1ji394no2.reqMessage(required, keys);
      var unsupported = $_bvyg2j17lji394nhh.filter(keys, function (key) {
        return !$_bvyg2j17lji394nhh.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_6msrcs1a1ji394no2.unsuppMessage(unsupported);
      var r = {};
      $_bvyg2j17lji394nhh.each(required, function (req) {
        r[req] = $_7dseed17nji394nhq.constant(obj[req]);
      });
      $_bvyg2j17lji394nhh.each(optional, function (opt) {
        r[opt] = $_7dseed17nji394nhq.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_qudbf19xji394nny = {
    immutable: Immutable,
  ...
  var $_3co1y11a2ji394no3 = { toArray: toArray };

  var node = function () {
    var f = $_eedmm818mji394nks.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_d4x5yy1a8ji394nol.unknown()
    });
  };
  ...
  var $_brwjfr1a7ji394noj = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_7dseed17nji394nhq.constant(edge),
    chrome: $_7dseed17nji394nhq.constant(chrome),
    ie: $_7dseed17nji394nhq.constant(ie),
    opera: $_7dseed17nji394nhq.constant(opera),
    firefox: $_7dseed17nji394nhq.constant(firefox),
    safari: $_7dseed17nji394nhq.constant(safari)
  };
  ...
  var $_5w4w9p1a9ji394nom = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_7dseed17nji394nhq.constant(windows$1),
    ios: $_7dseed17nji394nhq.constant(ios),
    android: $_7dseed17nji394nhq.constant(android),
    linux: $_7dseed17nji394nhq.constant(linux),
    osx: $_7dseed17nji394nhq.constant(osx),
    solaris: $_7dseed17nji394nhq.constant(solaris),
    freebsd: $_7dseed17nji394nhq.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_7dseed17nji394nhq.constant(isiPad),
      isiPhone: $_7dseed17nji394nhq.constant(isiPhone),
      isTablet: $_7dseed17nji394nhq.constant(isTablet),
      isPhone: $_7dseed17nji394nhq.constant(isPhone),
      isTouch: $_7dseed17nji394nhq.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_7dseed17nji394nhq.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_bvyg2j17lji394nhh.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_d4x5yy1a8ji394nol.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_d4x5yy1a8ji394nol.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_a3fyje1aeji394np1.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_a3fyje1aeji394np1.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_a3fyje1aeji394np1.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_a3fyje1aeji394np1.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_egwl811afji394np2.head(str).bind(function (head) {
      return $_egwl811afji394np2.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_d719ei1adji394np0.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_d719ei1adji394np0.contains(uastring, 'edge/') && $_d719ei1adji394np0.contains(uastring, 'chrome') && $_d719ei1adji394np0.contains(uastring, 'safari') && $_d719ei1adji394np0.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_d719ei1adji394np0.contains(uastring, 'chrome') && !$_d719ei1adji394np0.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_d719ei1adji394np0.contains(uastring, 'msie') || $_d719ei1adji394np0.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_d719ei1adji394np0.contains(uastring, 'safari') || $_d719ei1adji394np0.contains(uastring, 'mobile/')) && $_d719ei1adji394np0.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_d719ei1adji394np0.contains(uastring, 'iphone') || $_d719ei1adji394np0.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_9bf6ij1acji394nov = {
    browsers: $_7dseed17nji394nhq.constant(browsers),
    oses: $_7dseed17nji394nhq.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_9bf6ij1acji394nov.browsers();
    var oses = $_9bf6ij1acji394nov.oses();
    var browser = $_g3rng71abji394nor.detectBrowser(browsers, userAgent).fold($_brwjfr1a7ji394noj.unknown, $_brwjfr1a7ji394noj.nu);
    var os = $_g3rng71abji394nor.detectOs(oses, userAgent).fold($_5w4w9p1a9ji394nom.unknown, $_5w4w9p1a9ji394nom.nu);
  ...
  var $_fb8twh1a6ji394noj = { detect: detect$2 };

  var detect$3 = $_2eseip19tji394nnp.cached(function () {
    var userAgent = navigator.userAgent;
    return $_fb8twh1a6ji394noj.detect(userAgent);
  });
  var $_q8gf31a5ji394noh = { detect: detect$3 };

  var ELEMENT = $_5z90pg19vji394nnr.ELEMENT;
  var DOCUMENT = $_5z90pg19vji394nnr.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_bvyg2j17lji394nhh.map(base.querySelectorAll(selector), $_4902i019pji394nng.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_4902i019pji394nng.fromDom);
  };
  var $_73v0ib1agji394np3 = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_bvyg2j17lji394nhh.exists(elements, $_7dseed17nji394nhq.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_4lmbx91a4ji394noh.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_q8gf31a5ji394noh.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_1bk0b31a3ji394no4 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_73v0ib1agji394np3.is
  };

  var owner = function (element) {
    return $_4902i019pji394nng.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_4902i019pji394nng.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_4902i019pji394nng.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_4902i019pji394nng.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_bvyg2j17lji394nhh.findIndex(kin, function (elem) {
        return $_1bk0b31a3ji394no4.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_3vr27g17oji394nht.isFunction(isRoot) ? isRoot : $_7dseed17nji394nhq.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_4902i019pji394nng.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_bvyg2j17lji394nhh.filter(elements, function (x) {
        return !$_1bk0b31a3ji394no4.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_4902i019pji394nng.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_4902i019pji394nng.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_4902i019pji394nng.fromDom);
  };
  var prevSiblings = function (element) {
    return $_bvyg2j17lji394nhh.reverse($_3co1y11a2ji394no3.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_3co1y11a2ji394no3.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_bvyg2j17lji394nhh.map(dom.childNodes, $_4902i019pji394nng.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_4902i019pji394nng.fromDom);
  };
  ...
  var spot = $_qudbf19xji394nny.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_4s5mk919wji394nnr = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_bdrebr19sji394nnn.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_bvyg2j17lji394nhh.filter($_4s5mk919wji394nnr.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_bvyg2j17lji394nhh.filter($_4s5mk919wji394nnr.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_bvyg2j17lji394nhh.filter($_4s5mk919wji394nnr.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_bvyg2j17lji394nhh.each($_4s5mk919wji394nnr.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_73v0ib1agji394np3.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_99zay919rji394nnm.ancestors(scope, function (e) {
      return $_73v0ib1agji394np3.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_99zay919rji394nnm.siblings(scope, function (e) {
      return $_73v0ib1agji394np3.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_99zay919rji394nnm.children(scope, function (e) {
      return $_73v0ib1agji394np3.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_73v0ib1agji394np3.all(selector, scope);
  };
  var $_5t6qez19qji394nnl = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_bvyg2j17lji394nhh.map($_5t6qez19qji394nnl.descendants($_4902i019pji394nng.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_633qkx19oji394nne.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_7dseed17nji394nhq.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_bvyg2j17lji394nhh.map($_bvyg2j17lji394nhh.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_bvyg2j17lji394nhh.map($_bvyg2j17lji394nhh.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_bvyg2j17lji394nhh.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_ed40lt19nji394nn6 = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_7dseed17nji394nhq.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_bvyg2j17lji394nhh.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_bvyg2j17lji394nhh.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_bvyg2j17lji394nhh.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_bvyg2j17lji394nhh.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_bvyg2j17lji394nhh.indexOf(items, url).isNone()) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_ed40lt19nji394nn6.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_3vr27g17oji394nht.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_bdrebr19sji394nnn.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_4902i019pji394nng.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_4902i019pji394nng.fromDom(element.parentNode), function (x) {
      return !$_1bk0b31a3ji394no4.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_bvyg2j17lji394nhh.find(scope.dom().childNodes, $_7dseed17nji394nhq.compose(predicate, $_4902i019pji394nng.fromDom));
    return result.map($_4902i019pji394nng.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_4902i019pji394nng.fromDom(element.childNodes[i])))
          return Option.some($_4902i019pji394nng.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_73v0ib1agji394np3.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_8mt6we1amji394npe.ancestor(scope, function (e) {
      return $_73v0ib1agji394np3.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_8mt6we1amji394npe.sibling(scope, function (e) {
      return $_73v0ib1agji394np3.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_8mt6we1amji394npe.child(scope, function (e) {
      return $_73v0ib1agji394np3.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_73v0ib1agji394np3.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_73v0ib1agji394np3.is, ancestor$1, scope, selector, isRoot);
  };
  var $_fqider1alji394npd = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_7dx2av1aoji394npt = { register: register };
  ...
  var $_7e4p1s1aqji394npv = { register: register$1 };
  ...
  var $_zg9ok1arji394npw = { register: register$2 };
  ...
  var $_9i4wlo1asji394npy = { register: register$3 };
  ...
  var $_cjl7wm1atji394nq0 = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_bvyg2j17lji394nhh.flatten(global$4.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_bvyg2j17lji394nhh.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_bvyg2j17lji394nhh.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_4miiyv1auji394nq2 = { register: register$5 };
  ...
  var $_cbgev51avji394nq4 = { register: register$6 };
  ...
  var $_34vbz11awji394nq5 = { register: register$7 };
  ...
  var $_bf8qcj1axji394nq6 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_fqider1alji394npd.descendant($_4902i019pji394nng.fromDom(document.body), editor.settings.ui_container).fold($_7dseed17nji394nhq.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_cjl7wm1atji394nq0.register(editor);
    $_7dx2av1aoji394npt.register(editor);
    $_cbgev51avji394nq4.register(editor);
    $_34vbz11awji394nq5.register(editor);
    $_zg9ok1arji394npw.register(editor);
    $_7e4p1s1aqji394npv.register(editor);
    $_9i4wlo1asji394npy.register(editor);
    $_bf8qcj1axji394nq6.register(editor);
    $_4miiyv1auji394nq2.register(editor);
  };
  var $_151bqd1akji394npb = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_3vr27g17oji394nht.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_3vr27g17oji394nht.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_5at7nc182ji394nj2,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_bgnvxn18gji394nki,
      Panel: Panel,
      Movable: $_7vhd19184ji394nj5,
      Resizable: $_82ir7j18hji394nkk,
      ...
      FormatControls: $_151bqd1akji394npb,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_151bqd1akji394npb.setup(editor);
    $_6grdfb18jji394nkn.addToEditor(editor, panel);
    return $_dyjnlz16zji394ngg.get(editor, panel);
  });
  function Theme () {
  }
