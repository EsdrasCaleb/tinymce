...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_433gu1erji394ire.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_433gu1erji394ire.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_433gu1erji394ire.getSelectorConverter(editor)) {
      selectorConverter = $_433gu1erji394ire.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_433gu1erji394ire.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_433gu1erji394ire.getCssGroups(editor));
      ...
      if (!$_433gu1erji394ire.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_433gu1erji394ire.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_2m5gnfemji394ira.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_382x8felji394ir9 = { get: get };

  global.add('importcss', function (editor) {
    $_2m5gnfemji394ira.setup(editor);
    return $_382x8felji394ir9.get(editor);
  });
  function Plugin () {
  }
