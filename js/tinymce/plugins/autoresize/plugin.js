...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_8lqg508qji394i5d.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_8lqg508qji394i5d.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_8lqg508qji394i5d.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_8lqg508qji394i5d.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_8lqg508qji394i5d.getAutoResizeBottomMargin(editor);
    ...
    if ($_8lqg508qji394i5d.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_1uk4xu8nji394i5a.resize(editor, oldSize);
    });
  };
  var $_5im90f8mji394i59 = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_5im90f8mji394i59.register(editor, oldSize);
      $_1uk4xu8nji394i5a.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
