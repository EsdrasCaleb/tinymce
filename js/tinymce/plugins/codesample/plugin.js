...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_4pevuba1ji394i9q.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_4jy1e39xji394i8v.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_2r9aze9zji394i8w.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_307q0a2ji394i9r = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_dniias9wji394i8u = {
    open: function (editor) {
      var minWidth = $_4jy1e39xji394i8v.getDialogMinWidth(editor);
      var minHeight = $_4jy1e39xji394i8v.getDialogMinHeight(editor);
      var currentLanguage = $_307q0a2ji394i9r.getCurrentLanguage(editor);
      var currentLanguages = $_307q0a2ji394i9r.getLanguages(editor);
      var currentCode = $_2r9aze9zji394i8w.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_2r9aze9zji394i8w.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_4pevuba1ji394i9q.isCodeSample(node)) {
        $_dniias9wji394i8u.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_acvavc9vji394i8t = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_4pevuba1ji394i9q.trimArg($_4pevuba1ji394i9q.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_4pevuba1ji394i9q.trimArg($_4pevuba1ji394i9q.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_12qu14a3ji394i9u = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_4jy1e39xji394i8v.getContentCss(editor);
  ...
  var $_bx4ceaa4ji394i9v = { loadCss: loadCss };
  ...
  var $_cmtthxa5ji394i9w = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_12qu14a3ji394i9u.setup(editor);
    $_cmtthxa5ji394i9w.register(editor);
    $_acvavc9vji394i8t.register(editor);
    editor.on('init', function () {
      $_bx4ceaa4ji394i9v.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_4pevuba1ji394i9q.isCodeSample(ev.target)) {
        $_dniias9wji394i8u.open(editor);
      }
    });
  });
