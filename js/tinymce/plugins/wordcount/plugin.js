...
var wordcount = (function () {
  ...
  var $_b0zh1msrji394ko4 = {
    each: each,
    map: map
  };

  var SETS$1 = $_bgd0nespji394knu.SETS;
  var OTHER = $_bgd0nespji394knu.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_b0zh1msrji394ko4.map(string.split(''), memoized);
  };
  var $_8hgx34sqji394knx = { classify: classify };

  var ci = $_bgd0nespji394knu.characterIndices;
  ...
  var $_dh7io7ssji394ko5 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_bgd0nespji394knu.EMPTY_STRING;
  var WHITESPACE$1 = $_bgd0nespji394knu.WHITESPACE;
  var PUNCTUATION$1 = $_bgd0nespji394knu.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_8hgx34sqji394knx.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_dh7io7ssji394ko5.isWordBoundary(map, i)) {
  ...
  var $_758xyisoji394kns = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_758xyisoji394kns.getWords(getTextContent(editor)).length;
  };
  var $_5tqn83snji394knr = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_5tqn83snji394knr.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_65vittsmji394knr = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_5tqn83snji394knr.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_ctb7vwstji394ko7 = { setup: setup };

  global.add('wordcount', function (editor) {
    $_ctb7vwstji394ko7.setup(editor);
    return $_65vittsmji394knr.get(editor);
  });
  function Plugin () {
  }
