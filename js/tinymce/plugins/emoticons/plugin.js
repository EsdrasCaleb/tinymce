...
var emoticons = (function () {
  ...
  var $_8xx4o5avji394icb = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_8xx4o5avji394icb.getHtml(pluginUrl);
  ...
  var $_35ejajauji394ica = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_35ejajauji394ica.register(editor, pluginUrl);
  });
  function Plugin () {
  }
