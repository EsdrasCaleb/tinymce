...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_2vko2kisji394j39.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_2vko2kisji394j39.getPreviewDialogWidth(editor);
    var dialogHeight = $_2vko2kisji394j39.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_diq5tsitji394j3a.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_4j8qmxiqji394j38 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_4j8qmxiqji394j38.open(editor);
    });
  };
  var $_b5urhwipji394j37 = { register: register };
  ...
  var $_d7rmwdivji394j3b = { register: register$1 };

  global.add('preview', function (editor) {
    $_b5urhwipji394j37.register(editor);
    $_d7rmwdivji394j3b.register(editor);
  });
  function Plugin () {
  }
