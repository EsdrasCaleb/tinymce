...
var help = (function () {
  ...
  var never$1 = $_5si7rnb4ji394icv.never;
  var always$1 = $_5si7rnb4ji394icv.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_5si7rnb4ji394icv.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_ck3x9rb5ji394id3.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_bwrvyjb2ji394icq = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var $_ezykohb7ji394id4 = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_bwrvyjb2ji394icq.map($_ezykohb7ji394id4.shortcuts, function (shortcut) {
  ...
  var $_61j8ylb1ji394icm = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_65rxnubcji394idf.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_65rxnubcji394idf.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_65rxnubcji394idf.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_65rxnubcji394idf.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_cn6435bdji394idg.head(str).bind(function (head) {
      return $_cn6435bdji394idg.tail(str).map(function (tail) {
  ...
  var $_heg2obeji394idh = { urls: urls };

  var makeLink = $_5si7rnb4ji394icv.curry($_acrj4kbbji394ide.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_bwrvyjb2ji394icq.find($_heg2obeji394idh.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_25607ibaji394idc.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_bwrvyjb2ji394icq.filter(keys, $_5si7rnb4ji394icv.not($_5si7rnb4ji394icv.curry($_bwrvyjb2ji394icq.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_bwrvyjb2ji394icq.map(pluginKeys, function (key) {
  ...
  var $_6e6q6rb9ji394id6 = { makeTab: makeTab$1 };
  ...
  var $_2kcxjnbfji394idi = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_61j8ylb1ji394icm.makeTab(),
          $_6e6q6rb9ji394id6.makeTab(editor)
        ],
        buttons: $_2kcxjnbfji394idi.makeRow(),
  ...
  var $_8eqhkvb0ji394icl = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_8eqhkvb0ji394icl.open(editor, pluginUrl));
  };
  var $_e9f0s2azji394icl = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_8eqhkvb0ji394icl.open(editor, pluginUrl)
    });
  ...
  var $_f340oobhji394idj = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_f340oobhji394idj.register(editor, pluginUrl);
    $_e9f0s2azji394icl.register(editor, pluginUrl);
