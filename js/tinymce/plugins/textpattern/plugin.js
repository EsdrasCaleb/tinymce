...
var textpattern = (function () {
  ...
  var $_4xjp4hr3ji394kix = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_ga9g4krbji394kj6.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_ga9g4krbji394kj6.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_ga9g4krbji394kj6.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_5eohopr8ji394kj3.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_5eohopr8ji394kj3.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_5eohopr8ji394kj3.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !global$2.modifierPressed(e)) {
        $_1a34wvr7ji394kj1.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_1a34wvr7ji394kj1.checkKeyCode(keyCodes, e)) {
        $_1a34wvr7ji394kj1.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_1a34wvr7ji394kj1.checkCharCode(charCodes, e)) {
  ...
  var $_8b9kvbr4ji394kiz = { setup: setup };

  global.add('textpattern', function (editor) {
    var patternsState = Cell($_4xjp4hr3ji394kix.getPatterns(editor.settings));
    $_8b9kvbr4ji394kiz.setup(editor, patternsState);
    return $_bztxhkr2ji394kix.get(patternsState);
  });
  function Plugin () {
  }
