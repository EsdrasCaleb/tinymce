...
var contextmenu = (function () {
  ...
  var $_5focatagji394ibm = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_1rt4dzafji394ibk.getContextMenu(editor);
  ...
  var $_7u4uwtajji394ibo = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_1rt4dzafji394ibk.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_7u4uwtajji394ibo.show(editor, $_5focatagji394ibm.getPos(editor, e), visibleState, menu);
    });
  };
  var $_fk59t1aeji394ibi = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_fk59t1aeji394ibi.setup(editor, visibleState, menu);
    return $_6af72tadji394ibh.get(visibleState);
  });
  function Plugin () {
  }
